openerp.web_manikarnika = function(instance) {
    ...
    self.grain_dataset.read_slice([], {'domain': []}).done(function(records) {
    	order_list = records;
    	_.each(records, function(r){
    		self.grain_line_dataset = new instance.web.DataSetSearch(self, 'gorder.tacking.line', {}, [['id','in', r.gorder_tacking_line_ids]]);
    	    self.grain_line_dataset.read_slice([], {'domain': []}).done(function(line_rec) {
    	    	val_list = []
    ...
    instance.web.client_actions.add('grains.homepage', 'instance.web_manikarnika.action');
