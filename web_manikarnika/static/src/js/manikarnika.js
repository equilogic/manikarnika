...
//  ************************* Delivery Schedule Manikarnika *************************
    ...
    /*Action of  delivery_manik_action */
        ...
        start: function(date_value) {
            ...
            self.grain_dataset.call('get_morder_tacking_line',[[],current_date]).done(function(result){
                ...
                if(result[0].length != 0){
                    ...
                    console.log("item_dicitem_dicitem_dic",item_dic)
    ...
    /*Action of  delivery_grain_action */
...
//    ********************************* Manikarnika Order ***********************************
    ...
    /*Action of manik_order_action Interface*/
    ...
    instance.web_manikarnika.manik_order_action = instance.web.Widget.extend({
        ...
        console.log('order_dic',order_dic)
        if(view){
...
//  ********************************* Grains Order ***********************************
    /*Action of gr_order_action Interface*/
